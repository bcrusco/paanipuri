...
if /i "%1"=="vs2015"       (set TBB_TARGET_VS=vc_mt)     & shift & goto ParseArgs
...
echo        vs2015      : Set to use with Microsoft Visual Studio 2015 (TBB statically linked with Microsoft Visual C++ runtime)
